...
public class StoneDense {
    ...
    public static Map<String, OreBlockProperties> ORES = new HashMap<String, OreBlockProperties>() {{
        put("COAL_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.COAL_ORE, "STONE", true), 1, COMMON),
                Blocks.COAL_ORE.getDefaultState(),
                new LootTableProvider(Items.COAL, 3.0f)
        ));
        put("IRON_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.IRON_ORE, "STONE", true), 1, COMMON),
                Blocks.IRON_ORE.getDefaultState(),
                new LootTableProvider(Items.IRON_ORE, 3.0f)
        ));
        put("GOLD_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.GOLD_ORE, "STONE", true), 2, UNCOMMON),
                Blocks.GOLD_ORE.getDefaultState(),
                new LootTableProvider(Items.GOLD_ORE, 3.0f)
        ));
        put("DIAMOND_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.DIAMOND_ORE, "STONE", true), 2, RARE),
                Blocks.DIAMOND_ORE.getDefaultState(),
                new LootTableProvider(Items.GOLD_ORE, 3.0f)
        ));
        put("EMERALD_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.EMERALD_ORE, "STONE", true), 2, RARE),
                Blocks.EMERALD_ORE.getDefaultState(),
                new LootTableProvider(Items.GOLD_ORE, 3.0f)
        ));
        put("LAPIS_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.LAPIS_ORE, "STONE", true), 2, UNCOMMON),
        ...
        put("REDSTONE_ORE", new OreBlockProperties(
                new RedstoneOre(registryName(Registries.REDSTONE_ORE, "STONE", true), 2, COMMON),
                Blocks.REDSTONE_ORE.getDefaultState(),
                new LootTableProvider(Items.REDSTONE, 9.0F, 17.0F)
        ));
        // --> MODDED ORES
        put("ALUMINIUM_ORE", new OreBlockProperties(
                new BasicOre(registryName(Registries.ALUMINIUM_ORE, "STONE", true), 1, COMMON),
        ...
        put("AMETHYST_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.AMETHYST_ORE, "STONE", true), 2, RARE),
                Stone.ORES.get("AMETHYST_ORE").getBlockState(),
                new LootTableProvider(GemsItems.AMETHYST, 3.0f)
        ));
        put("COPPER_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.COPPER_ORE, "STONE", true), 1, COMMON),
        ...
        put("LEAD_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.LEAD_ORE, "STONE", true), 1, UNCOMMON),
        ...
        put("OSMIUM_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.OSMIUM_ORE, "STONE", true), 2, UNCOMMON),
        ...
        put("RUBY_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.RUBY_ORE, "STONE", true), 2, RARE),
                Stone.ORES.get("RUBY_ORE").getBlockState(),
                new LootTableProvider(GemsItems.RUBY, 3.0f)
        ));
        put("SAPPHIRE_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.SAPPHIRE_ORE, "STONE", true), 2, RARE),
                Stone.ORES.get("SAPPHIRE_ORE").getBlockState(),
                new LootTableProvider(GemsItems.SAPPHIRE, 3.0f)
        ));
        put("SILVER_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.SILVER_ORE, "STONE", true), 2, UNCOMMON),
        ...
        put("TIN_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.TIN_ORE, "STONE", true), 1, COMMON),
        ...
        put("URANIUM_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.URANIUM_ORE, "STONE", true), 2, RARE),
        ...
        put("ZINC_ORE",  new OreBlockProperties(
                new BasicOre(registryName(Registries.ZINC_ORE, "STONE", true), 2, UNCOMMON),
    ...
    public static class RegistryEvents {
        ...
        public static void onBlocksRegistry(final RegistryEvent.Register<Block> event) {
            for (Map.Entry<String, OreBlockProperties> ORE : ORES.entrySet()) {
                ...
                Janoeo.logger.debug("JANOEO DENSE STONE ORE -> REGISTER BLOCK: " + ORE.getValue().getBlock());
            }
        }
